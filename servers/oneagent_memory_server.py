...
class MemoryConfig:
    ...
    def __init__(self):
        ...
        self.port = int(os.getenv('MEMORY_PORT', '8000'))
...
class MemoryMetadata(BaseModel):
    """Memory metadata with validation"""
    source: Optional[str] = None
    memoryType: Optional[str] = Field(default="long_term", regex="^(short_term|long_term|workflow|session)$")
