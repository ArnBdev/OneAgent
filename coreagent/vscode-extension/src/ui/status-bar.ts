  ...
  private async updateStatus(): Promise<void> {
    try {
      ...
      if (isConnected) {
        ...
        try {
          ...
          if (healthResult.success) {
            ...
            this.statusBarItem.tooltip =
              'OneAgent connected but health check failed - Click for details';
          }
        } catch {
        ...
        this.statusBarItem.tooltip =
          'OneAgent Professional - Not available | Ensure OneAgent is running (check .env for configuration)';
      }
    } catch (error) {
