...
REM Start MCP Server (Node/TSX)
echo [OneAgent] Starting MCP Server (Node/TSX)...
start "MCP Server (Node/TSX)" cmd /k "cd /d %~dp0.. && npx tsx coreagent/server/unified-mcp-server.ts"
