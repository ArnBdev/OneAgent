...
function getConfigSummary() {
  ...
  Environment: ${exports.oneAgentConfig.environment}
  Memory Server: ${exports.oneAgentConfig.memoryUrl}
  MCP Server: ${exports.oneAgentConfig.mcpUrl}
  UI Server: ${exports.oneAgentConfig.uiUrl}
  Memory Storage: ${exports.oneAgentConfig.memoryStoragePath}
  API Keys: ${exports.oneAgentConfig.geminiApiKey ? 'Gemini ✓' : 'Gemini ✗'} ${exports.oneAgentConfig.braveApiKey ? 'Brave ✓' : 'Brave ✗'}`;
}
