...
exports.devAgent = exports.DevAgent = void 0;
const BaseAgent_1 = require("../base/BaseAgent");
const uuid_1 = require("uuid");
/**
 * Development Agent - BaseAgent implementation
 */
class DevAgent extends BaseAgent_1.BaseAgent {
    constructor() {
        const config = {
            id: 'DevAgent',
            name: 'DevAgent',
     ...
     */
    async generateDevelopmentResponse(message, context, requestType) {
     ...
     */
    buildDevelopmentPrompt(message, requestType, memories) {
...
Provide helpful, actionable development guidance with specific examples where appropriate.`;
     ...
     */
    createDevResponse(content, requestType) {
        return {
            content,
            actions: [{
