...
exports.MemoryEditTool = void 0;
const UnifiedMCPTool_1 = require("./UnifiedMCPTool");
class MemoryEditTool extends UnifiedMCPTool_1.UnifiedMCPTool {
    constructor() {
        const schema = {
            type: 'object',
            properties: {
        ...
        super('oneagent_memory_edit', 'Edit existing memory content and metadata', schema, 'enhanced' // Constitutional AI level
        );
    }
    /**
    ...
    async executeCore(args) {
        try {
            ...
            const searchResult = await this.unifiedMemoryClient.getMemoryContext(args.memoryId, args.userId, 1);
...
exports.MemoryEditTool = MemoryEditTool;
