...
class ProfileManager {
     ...
     */
    async loadProfile(profileName = 'oneagent-profile') {
        try {
     ...
     */
    async saveProfile(profile, profileName = 'oneagent-profile') {
        try {
     ...
     */
    async archiveCurrentVersion(profileName) {
        try {
     ...
     */
    async loadBackupOrDefault(profileName) {
     ...
     */
    async createDefaultProfile(profileName) {
     ...
     */
    async getProfileHistory(profileName) {
        try {
     ...
     */
    async rollbackProfile(profileName, targetVersion) {
        try {
     ...
     */
    async updateCapabilityUsage(capabilityName, success, qualityScore) {
