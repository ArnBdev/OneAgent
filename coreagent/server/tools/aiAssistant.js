...
exports.AIAssistantTool = void 0;
class AIAssistantTool {
    ...
    async ask(question, options) {
        ...
        try {
            console.log(`🤖 AI Assistant: Processing question "${question.substring(0, 50)}..."`);
            const chatOptions = {
     ...
     */
    async analyze(text, instruction, options) {
        const startTime = Date.now();
        try {
            console.log(`🤖 AI Assistant: Analyzing text with instruction "${instruction.substring(0, 30)}..."`);
            const response = await this.geminiClient.analyzeText(text, instruction, {
     ...
     */
    async helpWithWorkflow(workflowName, currentStep, context) {
...
Can you help me understand what I should do next or provide guidance for completing this step effectively?`;
     ...
     */
    async suggestWorkflowImprovements(workflowDescription) {
...
exports.AIAssistantTool = AIAssistantTool;
